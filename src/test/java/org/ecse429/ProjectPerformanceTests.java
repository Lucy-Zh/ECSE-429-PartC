...
public class ProjectPerformanceTests {
  ...
  private HttpResponse<String> createProject(
      String title, Boolean isActive, Boolean isCompleted, String description)
  ...
  private HttpResponse<String> editProjectById(
      int projectId, String title, Boolean isActive, Boolean isCompleted, String description)
      throws IOException, InterruptedException {
    JsonObject requestJson = new JsonObject();
    requestJson.addProperty("title", title);
    requestJson.addProperty("active", isActive);
  ...
  private HttpResponse<String> deleteProjectById(int projectId)
      throws IOException, InterruptedException {
    HttpRequest request =
        HttpRequest.newBuilder()
            .uri(URI.create("http://localhost:4567/projects/" + projectId))
  ...
  public void testCreateProjectPerformance() throws IOException, InterruptedException {
    ...
    PerformanceTestUtils.writeDataToNewCSVFile(
        "CreateProjectResults.csv", transactionTime, memoryUsage, cpuUsage);
  }
  ...
  public void testEditProjectPerformance() throws IOException, InterruptedException {
    ...
    PerformanceTestUtils.writeDataToNewCSVFile(
        "EditProjectResults.csv", transactionTime, memoryUsage, cpuUsage);
  }
  ...
  public void testDeleteProjectPerformance() throws IOException, InterruptedException {
    ...
    PerformanceTestUtils.writeDataToNewCSVFile(
        "DeleteProjectResults.csv", transactionTime, memoryUsage, cpuUsage);
  }
}
